...
@property (weak) id<FXTextViewDelegate> delegate;
@property (nonatomic, copy) NSString* string;
@property (unsafe_unretained, nonatomic) NSFont* font;
...
@property (nonatomic) id<FXSyntaxHighlighter> syntaxHighlighter;
